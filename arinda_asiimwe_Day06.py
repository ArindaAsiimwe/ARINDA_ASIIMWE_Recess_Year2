...
If no exception is raised in the try block it runs

4. Finally: it runs whether an exception occurs or not
Used for cleaning up actions
...
# Exercise 1: Write a function that converts a string to an integer and handle
# both ValueError if the string cannot be converted into an integer and 
